...
public class TimingChecker : MonoBehaviour
{
    ...
    // Color violeta
    public Color violetColor = new Color(0.6f, 0.2f, 0.8f, 1f);
    ...
    void Start()
    {
        ...
        originalColor = circleSpriteRenderer.color;
    ...
    void Tick()
    {
        ...
        // Cambia el color del sprite a violeta
        circleSpriteRenderer.color = violetColor;

        // Inicia la corutina para volver al color original después de un tiempo
